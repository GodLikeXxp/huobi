    ...
    public void run(String host, int port) {
        executorService.submit(() -> {
            ...
            try {
            	...
            	System.out.println("优雅退出，释放NIO线程组");
            }
        });
    }
